            ...
            <header className="h-16 border-b border-slate-100 px-6 flex items-center relative">
                ...
                <div className="flex items-center gap-3 z-10">
                    ...
                    <div className="flex flex-col">
                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-tighter leading-none">Lesson</span>
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className={`flex items-center gap-2 px-4 py-1.5 rounded-full border-2 transition-all duration-300 ${
                        timeLeft < 10 
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-4 md:p-8">
                <div className="w-full max-w-2xl">
                    ...
                    <div className="min-h-[80px]">
                        {currentResult && (
                            <div className={`p-4 rounded-2xl flex items-center justify-between border-2 transition-all animate-in zoom-in-95 duration-300 ${
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        {!currentResult.isCorrect && (
                                            <span className="text-xs font-bold opacity-80">
                                                To'g'ri javob: {String.fromCharCode(65 + currentResult.correctIdx)}
                                            </span>
                                        )}
                                    </div>
                                </div>
                                ...
                                {currentIndex === totalQuestions - 1 ? (
                                    ...
                                    >
                                        Yakunlash <Send size={16} />
                                    </button>
                                ) : (
                                    <button
                                        onClick={handleNext}
                                        className={`px-8 py-3 rounded-xl text-sm font-black text-white transition-all shadow-xl active:scale-95 flex items-center gap-2 ${
                                            currentResult.isCorrect ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-rose-600 hover:bg-rose-700'
                                        }`}
                                    >
