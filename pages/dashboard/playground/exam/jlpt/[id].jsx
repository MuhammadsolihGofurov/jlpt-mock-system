...
import { ExamPlayground, JLPTExamPlayground } from "@/components/custom/playground";
...
const ExamPlaygroundPage = ({ customLoading }) => {
  ...
  const { startSecurity, stopSecurity, attachSubmissionId } = useExamSecurity(currentExamType);
    ...
    <>
      ...
      <div className="min-h-screen bg-[#FDFDFF] text-slate-900 selection:bg-primary/10 pb-10">
        ...
        <nav className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8 flex justify-between items-center">
          <button
            onClick={() => router.push("/dashboard/assignments/exam-jlpt")}
